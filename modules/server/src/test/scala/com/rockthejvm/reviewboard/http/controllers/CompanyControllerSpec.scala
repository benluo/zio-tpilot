...
object CompanyControllerSpec extends ZIOSpecDefault:
  ...
  private val rtjvm =
    Company(1L, "rock-the-jvm", "Rock the JVM", "rockthejvm.com")
  ...
  private def backendStubZIO(
      f: ED
  ): RIO[CompanyService & JwtService, SttpBackend[Task, Nothing]] =
    for
  ...
  private def controller(
      f: ED
  )(req: Req): RIO[CompanyService & JwtService, Either[String, String]] =
    for
