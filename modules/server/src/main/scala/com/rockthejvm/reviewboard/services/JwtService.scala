...
trait JwtService:
   ...
   * @return a task containing the created token
   */
   ...
   * @return a task containing the verified user's extracted info
   */
 ...
 * @param jwtConfig configuration for how to generate tokens (i.e., secret, expiration length, etc.)
 * @param clock instance to handle current time in token verifier
 */
