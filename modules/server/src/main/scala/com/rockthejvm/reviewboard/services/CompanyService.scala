...
trait CompanyService:
   ...
   * @param req the properties of the company to create
   * @return a task containing the created company
   */
  def create(req: CreateCompanyRequest): Task[Company]

  /**
   * Get all companies
   * @return a task containing all found companies
   */
  def getAll: Task[List[Company]]

  /**
   * Get all distinct filterable/searchable attributes of all companies
   * @return a task containing a populated CompanyFilter instance
   */
  def allFilters: Task[CompanyFilter]

  /**
   * Search for all companies that match a given CompanyFilter criteria
   * @param filter the criteria to match companies against
   * @return a task containing all companies that match the criteria
   */
   ...
   * @return a task containing an option of the company with the given id
   */
  def getById(id: Long): Task[Option[Company]]

  /**
   * Get a company by its slug attribute
   * @param slug the slug to search with
   * @return a task containing an option of the company with the given id
   */
 ...
 * @param repo the repository instance to access data with
 */
